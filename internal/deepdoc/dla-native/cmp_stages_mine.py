...
class StageDBPostProcess(pp.DBPostProcess):
    def boxes_from_bitmap(self, pred, _bitmap, dest_width, dest_height):
        ...
        # Use the prototype Moore/Suzuki-Abe contour tracer instead of cv2,
        # to validate the algorithm before porting to Go.
        from find_contours_proto import find_contours as _fc
        contours = _fc((bitmap > 0).astype(np.uint8))
